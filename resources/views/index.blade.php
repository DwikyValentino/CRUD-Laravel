    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ action('PersediaanBarangController@edit', $pb->id) }}" class="btn btn-warning">Ubah Data</a>
                <button formaction="{{ action('PersediaanBarangController@destroy', $pb->id) }}" type="submit" class="btn btn-danger"> - Hapus Data</button>
            </td>
        </tr>
        @endforeach
    </tbody>
